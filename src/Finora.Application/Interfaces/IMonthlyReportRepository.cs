...
public interface IMonthlyReportRepository
{
    ...
    Task<bool> UpdateGeneratedMetadataAsync(Guid id, DateTime generatedAt, long fileSizeBytes, int templateVersion, CancellationToken cancellationToken = default);
}
