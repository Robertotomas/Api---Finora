...
namespace Finora.Infrastructure.Migrations
{
    ...
    [Migration("20260722214458_AddInvestmentDepositAccount")]
    partial class AddInvestmentDepositAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finora.Domain.Entities.InstrumentQuote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("InstrumentQuotes");
                });

            modelBuilder.Entity("Finora.Domain.Entities.InvestmentDeposit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Finora.Domain.Entities.RecurringTransaction", b =>
                {
                    ...
                    b.HasOne("Finora.Domain.Entities.Account", "DestinationAccount")
                        .WithMany()
